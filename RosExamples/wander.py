...
# chmod +x wander.py (how to add python)
# # rostopic echo scan - used to show scan readings in cmd

# The queue_size=1 argument tells rospy to only buffer a single outbound message.
